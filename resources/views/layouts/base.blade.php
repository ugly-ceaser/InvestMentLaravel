...
<nav class="navbar navbar-default  navbar-transparent bootsnav">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/">
                <img src="{{ asset('storage/app/public/' . $settings->logo) }}" class="logo logo-display w-50" alt="Logo" width="250" height="600">
        ...
        <div class="collapse navbar-collapse" id="navbar-menu">
            <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-label="Legal options">Legal</a>
    ...
    <div class="side">
        ...
        <div class="widget">
            ...
            <p>
                We give a chance to new, dynamically developing ICO projects that bring huge profits in an amazing short time. Join Us by choosing one of our plans today. Your success starts with your broker and the right trading conditions along with all the tools you need to get you there.
            </p>
    ...
    <footer class="bg-dark">
                    ...
                    <div class="col-md-4   item">
                        <div class="f-item twitter-widget">
                            ...
                            <div class="twitter-item">
                                <div class="twitter-content">
                                    <p>
                                    <i class="fas fa-phone"></i>{{$settings->whatsapp}}</p>
                                </div>
        ...
        <div class="footer-bottom bg-dark text-light">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <p>&copy; Copyright {{$settings->twak}}. All Rights Reserved </p>
                    </div>
